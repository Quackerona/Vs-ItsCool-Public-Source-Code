...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Damn You've Actually Beaten Me",		"Beat ItsCool Week on Hard",				'week1_nomiss',			false],
		["Beat Inky Week",				"Beat Inky Week on Hard",				'week2_nomiss',			false],
		["Coming Soon",				"Beat ??? Week on Hard",				'week3_nomiss',			false],
		["???",			"easter egg (hint : konami)",				'secret',			false],
	];

...
-- credits to Kris for some of the modchart code too (some of the lua. code was for the vs bambi expanded mod)
local angleshit = 1;
local anglevar = 1;
local turn = 10
local turn2 = 20
...
function onUpdate(elapsed)
    ...
    if spin == true and curBeat >= 96 and curBeat <= 288 then 
        for i = 0,7 do 
    ...
    if spin == true and curBeat >= 288 and curBeat <= 352 then 
        for i = 0,7 do 
            setPropertyFromGroup('strumLineNotes', i, 'x', defaultNotePos[i + 1][1] + arrowMoveX * math.sin((currentBeat + i*0.25) * math.pi))
            --setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] + arrowMoveY * math.cos((currentBeat + i*0.25) * math.pi))
        end
    end
    if spin == true and curBeat >= 352 and curBeat <= 367 then 
        for i = 0,7 do
            --setPropertyFromGroup('strumLineNotes', i, 'x', defaultNotePos[i + 1][1] + arrowMoveX * math.sin((currentBeat + i*0.25) * math.pi))
            setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] + arrowMoveY * math.cos((currentBeat + i*0.25) * math.pi))
        end
    end
    if spin == true and curBeat >= 367 and curBeat <= 384 then 
        for i = 0,7 do 
            setPropertyFromGroup('strumLineNotes', i, 'x', defaultNotePos[i + 1][1] + arrowMoveX * math.sin((currentBeat + i*0.25) * math.pi))
            setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] + arrowMoveY * math.cos((currentBeat + i*0.25) * math.pi))
        end
    end
    if spin == true and curBeat >= 384 and curBeat <= 416 then 
        for i = 0,7 do 
            setPropertyFromGroup('strumLineNotes', i, 'x', defaultNotePos[i + 1][1] + arrowMoveX * math.sin((currentBeat + i*0.25) * math.pi))
            --setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] + arrowMoveY * math.cos((currentBeat + i*0.25) * math.pi))
        end
    end
    if spin == true and curBeat >= 416 and curBeat <= 1981 then 
        for i = 0,7 do 
            --setPropertyFromGroup('strumLineNotes', i, 'x', defaultNotePos[i + 1][1] + arrowMoveX * math.sin((currentBeat + i*0.25) * math.pi))
            setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] + arrowMoveY * math.cos((currentBeat + i*0.25) * math.pi))
        end
...
function onBeatHit()
    ...
    if curBeat >= 384 and curBeat <= 1950 then -- 80 > 320
        if curBeat % 2 == 0 then
                angleshit = anglevar;
            else
                angleshit = -anglevar;
